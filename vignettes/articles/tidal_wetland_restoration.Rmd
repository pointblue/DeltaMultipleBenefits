...
```{r tidal_wetland_map, echo=FALSE, fig.cap="Map of potential tidal wetland, shown with existing tidal wetland and restoration projects planned, in progress, or completed", out.width = '50%'}
knitr::include_graphics("fig/tidal_wetland_map.jpg")
```

```{r potential_marsh, echo=FALSE, fig.cap="Potential suitable tidal wetland by region", out.width = '50%'}
knitr::include_graphics("fig/potential_marsh.jpg")
```
