...
* TBD: 
  * Total landscape scores for baseline and scenarios [in manuscript, but also make these scores downloadable?]
  * Other data required by riparian models: bio_1, bio_12, streamdist
  * Other data required by waterbird models: pwater, roost locations (also included in the DeltaMultipleBenefits package)
  * spp key?
