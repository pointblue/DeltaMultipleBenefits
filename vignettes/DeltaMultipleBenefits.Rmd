...
Currently, the only spatial models supported are the distribution models for riparian landbird species and groups of waterbird species. Their development is described in a manuscript (link TBD), and the models are available to download via Zenodo, doi:[10.5281/zenodo.7531945](https://doi.org/10.5281/zenodo.7531945). (They are a bit too large to include in this package.) However, spatial models for other species, and for other benefits categories could be incorporated in future versions of this package as they are developed.
...
At this stage, the steps for estimating the net change in the total amount of habitat provided by each scenario is similar to estimating the net change in the area of each land cover class and in each of the "simple metrics" above. 
