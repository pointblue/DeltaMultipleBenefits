...
predictors_waterbird_fall = readxl::read_excel(
  'C:/Users/kdybala/Documents/R_projects/delta_tima/dat_clean/veg_key.xlsx',
  'predictors_waterbirds_fall', na = 'NA') |>
  dplyr::arrange(CODE_NUM)
usethis::use_data(predictors_waterbird_fall, overwrite = TRUE)

predictors_waterbird_win = readxl::read_excel(
  'C:/Users/kdybala/Documents/R_projects/delta_tima/dat_clean/veg_key.xlsx',
  'predictors_waterbirds_win', na = 'NA') |>
  dplyr::arrange(CODE_NUM)
usethis::use_data(predictors_waterbird_win, overwrite = TRUE)
